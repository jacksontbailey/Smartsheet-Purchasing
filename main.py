...
def main():
    ...
    frame_layout = [
        [
            sg.Button(
                ...
                font=("any 10 bold"),
                k="-IMPORT-",
                tooltip="Import excel data into an empty Smartsheet",
                expand_x=True,
                p=((30, 7.5), (20, 5)),
            ),
            sg.Button(
                ...
                border_width=0,
                font=("any 10 bold"),
                k="-IMPORT WITH DUPLICATES-",
                tooltip="Import data with duplicates highlighted",
                expand_x=False,
                p=((7.5, 30), (20, 5)),
                size=(26, 1)
            ),
        ...
        [
            sg.Button(
                ...
                font=("any 10 bold"),
                k="-UPDATE-",
                tooltip="Update the existing Smartsheet with an excel file",
                expand_x=True,
                p=((30, 7.5), (10, 10)),
            ),
            sg.Button(
                ...
                font=("any 10 bold"),
                k="-NEW-",
                tooltip="Create a new Smartsheet",
                expand_x=True,
                p=((7.5, 30), (10, 10)),
            )
        ],
    ...
    window["-IMPORT WITH DUPLICATES-"].set_cursor(cursor="hand2")
    ...
    try:
        ...
        while True:
            ...
            # display the 'Import Data' window if the user clicks the 'Import Data' button
            elif event == "-IMPORT WITH DUPLICATES-":
                window.hide()
                import_sheet_window("Import With Duplicates", import_excel_data, event)
                window.un_hide()
...
if __name__ == "__main__":
    ...
    settings = sg.UserSettings(
        path=SETTINGS_PATH,
        filename=f"{SETTINGS_PATH}\\config.ini",
